...
urlpatterns = [
    ...
    path('user_guide/task/create/', views.user_guide_task_create, name='user_guide_task_create'),
    path('user_guide/task/manage/', views.user_guide_task_manage, name='user_guide_task_manage'),
