...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                w, h = get_text_size(self.font, label)  # text width, height
    ...
    def text(self, xy, text, txt_color=(255, 255, 255)):
        ...
        w, h = get_text_size(self.font, text)  # text width, height
...
def plot_results(file='path/to/results.csv', dir=''):
    ...
    if not files:
        # No results.csv found (e.g., in detection/inference mode)
        return
